        ...
        <section id="hero" className="scroll-mt-32 pt-16 md:pt-32 pb-16 border-b border-white/5">
          <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
              ...
              {data?.resume && (
                <a href={data.resume} target="_blank" rel="noreferrer" className="px-6 py-3 bg-white/5 text-white border border-white/10 text-sm font-bold rounded-lg hover:bg-white/10 transition-colors flex items-center gap-2">
