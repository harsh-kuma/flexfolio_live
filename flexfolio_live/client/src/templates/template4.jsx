        ...
        <div id="hero" className="scroll-mt-24 flex flex-col-reverse lg:flex-row items-center justify-between gap-16 min-h-[70vh]">
          ...
          <div className="flex-1 space-y-8 z-10 text-center lg:text-left">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-5 pt-4">
              ...
              {data?.resume?.url && (
                <a href={data.resume.url} onClick={() => trackClick("resume")} target="_blank" rel="noreferrer" className="flex items-center gap-2 px-8 py-4 border-2 border-slate-700 text-slate-300 rounded-2xl font-bold hover:bg-slate-800 hover:text-white transition-all hover:border-slate-600">
