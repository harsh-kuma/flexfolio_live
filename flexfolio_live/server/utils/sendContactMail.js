...
const transporter = nodemailer.createTransport({
  ...
  family: 4 // Keeps your Render IPv4 fix intact
});
...
exports.sendContactMail = async ({
  ...
  try {
            ...
            <div style="padding:32px;">
              ...
              <div style="margin-top:24px;background:#f9fafb;border:1px solid #e5e7eb;border-radius:12px;padding:22px;">
                <div style="margin-bottom:18px;">
                  ...
                  <p style="margin:4px 0 0;font-size:15px;font-weight:600;color:#111827;">${senderName}</p>
                </div>

                <div style="margin-bottom:18px;">
                  <p style="margin:0;font-size:12px;color:#6b7280;">Sender Email</p>
                  <p style="margin:4px 0 0;font-size:15px;font-weight:600;color:#2563eb;">${senderEmail}</p>
                </div>
              ...
              <div style="margin-top:28px;text-align:center;">
                <a href="mailto:${senderEmail}" style="display:inline-block;background:#2563eb;color:#ffffff;text-decoration:none;padding:12px 24px;border-radius:10px;font-size:14px;font-weight:600;">
                  Reply to ${senderName}
                </a>
              </div>
    ...
    // You can throw the error or return a failure object depending on how your API route is structured
